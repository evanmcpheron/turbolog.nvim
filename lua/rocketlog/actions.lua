...
function M.log_word_under_cursor(log_type)
  ...
  local generated_log_lines = build.build_rocket_log_lines(filename, log_line_number, current_word, log_type)

  local _, insert_err = insert.insert_after_statement(generated_log_lines, current_line_number, {
